    ...
    if search_query:
        ...
        if not search_result.empty:
            ...
            for _, row in search_result.iterrows():
                ...
                with c5: st.markdown(f"<div class='search-card'><div class='card-label'>성장률</div><div class='card-value'>{row['성장_표시']}</div></div>", unsafe_allow_html=True)
